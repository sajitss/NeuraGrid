<script lang="ts">
  ...
  let capabilities = [
    { code: 'Pd', title: 'People Detection', desc: 'timestamps of person appearances, or True/False if any person present', style: 'border-cyan-500 text-cyan-400 hover:bg-cyan-500/10 hover:shadow-[0_0_10px_rgba(6,182,212,0.5)]' },
    { code: 'Pr', title: 'Person Re‑Identification', desc: 'timestamps where a specific person reappears across cameras', style: 'border-purple-500 text-purple-400 hover:bg-purple-500/10 hover:shadow-[0_0_10px_rgba(168,85,247,0.5)]' },
    { code: 'Ot', title: 'Object Tracking', desc: 'timestamps of object movement across frames', style: 'border-emerald-500 text-emerald-400 hover:bg-emerald-500/10 hover:shadow-[0_0_10px_rgba(16,185,129,0.5)]' },
    { code: 'Vd', title: 'Vehicle Detection', desc: 'timestamps of car appearances, or True/False if any car present', style: 'border-orange-500 text-orange-400 hover:bg-orange-500/10 hover:shadow-[0_0_10px_rgba(249,115,22,0.5)]' },
    { code: 'Lp', title: 'License Plate Recognition', desc: 'timestamps of a specific plate, or True/False if matched', style: 'border-rose-500 text-rose-400 hover:bg-rose-500/10 hover:shadow-[0_0_10px_rgba(244,63,94,0.5)]' },
    { code: 'Vs', title: 'Video Search / Retrieval', desc: 'timestamps of query match, or True/False if found', style: 'border-fuchsia-500 text-fuchsia-400 hover:bg-fuchsia-500/10 hover:shadow-[0_0_10px_rgba(217,70,239,0.5)]' }
  ];
      ...
      <div class="flex flex-wrap gap-2">
        {#each capabilities as cap}
          <div class="group relative">
            <div class="w-10 h-10 flex items-center justify-center bg-gray-800/50 rounded-lg text-sm font-bold cursor-help transition-all duration-300 border {cap.style}">
              {cap.code}
            </div>
            <!-- Tooltip -->
